<%
    ...
    if(user == null) {
        session.setAttribute("message", "You are not logged in!! Login first to exit checkout page");
                    ...
                    <div class="card">
                        ...
                        <form action="#!">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<%= user.getUserName()%>" type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Enter contact Number">
                            </div>
                            <div class="form-group">
